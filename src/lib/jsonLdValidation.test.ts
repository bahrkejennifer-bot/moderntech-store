...
const buildBlogPostingGraph = (slug: string) => ({
  ...
  "@graph": [
    ...
    {
      "@type": "BreadcrumbList",
      "@id": `https://moderntech.store/weekly-edit/${slug}#breadcrumb`,
      itemListElement: [
        { "@type": "ListItem", position: 1, name: "Home", item: "https://moderntech.store/" },
        { "@type": "ListItem", position: 2, name: "Modern Tech: Weekly Edit", item: "https://moderntech.store/weekly-edit" },
        {
          "@type": "ListItem",
          position: 3,
          name: "How to Start Your First Podcast",
          item: `https://moderntech.store/weekly-edit/${slug}`,
        },
      ],
    },
    {
      ...
      mainEntityOfPage: { "@type": "WebPage", "@id": `https://moderntech.store/weekly-edit/${slug}#webpage` },
      url: `https://moderntech.store/weekly-edit/${slug}`,
      inLanguage: "en-US",
    ...
    validateNode(
      {
        ...
        mentions: [
          ...
          { "@type": "WebPage", "@id": "https://moderntech.store/weekly-edit#webpage" },
        ],
      },
      checks,
    );
    ...
    validateNode(
      {
        ...
        about: {
          "@type": "BlogPosting",
          "@id": "https://moderntech.store/weekly-edit/other#blogposting",
