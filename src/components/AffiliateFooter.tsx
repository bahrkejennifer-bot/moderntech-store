    ...
    >
      <div className="max-w-6xl mx-auto px-8 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {/* Company Info */}
          <div>
            <h3 className="font-serif text-2xl mb-4" style={{ fontStyle: "italic", color: "hsl(30 25% 95%)" }}>Modern Tech</h3>
            ...
            <div className="mt-8">
              <span className="font-mono text-[9px] tracking-[0.3em] uppercase" style={{ color: "hsl(30 25% 95% / 0.4)" }}>Follow</span>
              <div className="mt-3">
                <SocialLinks />
              </div>
              <div className="mt-3">
          ...
          {/* Legal Links */}
          <div>
            <h3 className="font-mono text-[9px] tracking-[0.3em] uppercase mb-6" style={{ color: "hsl(30 25% 95% / 0.4)" }}>Legal</h3>
              ...
              {[
                ...
                <li key={link.to}>
                  <Link
                    ...
                    style={{ color: "hsl(30 25% 95% / 0.6)" }}
                    onMouseEnter={(e) => (e.currentTarget.style.color = "hsl(30 25% 95%)")}
                    onMouseLeave={(e) => (e.currentTarget.style.color = "hsl(30 25% 95% / 0.6)")}
                  >
                    {link.label}
                  </Link>
                </li>
