...
const blogPostsData: Record<string, {
  ...
  "top-10-smart-home-devices-2025": {
    ...
    products: [
      ...
      { title: "Kidde Smoke & CO Detector", description: "Smart alerts, voice warnings, essential safety device", badge: "Safety Essential", rating: 4.7, imageUrl: kiddeDetectorImg, affiliateLink: "https://www.amazon.com/dp/B07H56MC3J?tag=moderntechs0c-20" },
      ...
      { title: "Philips SmartSleep Wake-Up Light", description: "Sunrise simulation, natural wake-up, sleep sounds", rating: 4.5, imageUrl: philipsWakeupImg, affiliateLink: "https://www.amazon.com/dp/B07JXWS3Z8?tag=moderntechs0c-20" },
  ...
  "wireless-earbuds-comparison-2025": {
    ...
    products: [
      ...
      { title: "Google Nest WiFi Pro 6E", description: "Next-gen WiFi, whole-home coverage, easy setup", rating: 4.5, imageUrl: nestWifiImg, affiliateLink: "https://www.amazon.com/dp/B0BCPDR56W?tag=moderntechs0c-20" },
      ...
      { title: "Tile Pro Bluetooth Tracker", description: "Never lose your items, long range, replaceable battery", rating: 4.5, imageUrl: tileProImg, affiliateLink: "https://www.amazon.com/dp/B09B2W7WF3?tag=moderntechs0c-20" }
    ]
  },
  "tech-essentials-college-students": {
    ...
    products: [
      ...
      { title: "Rocketbook Flex Planner", description: "Reusable smart notebook, cloud sync, eco-friendly", rating: 4.5, imageUrl: rocketbookImg, affiliateLink: "https://www.amazon.com/dp/B09QRVCJYL?tag=moderntechs0c-20" },
  ...
  "best-fitness-trackers-every-budget": {
    ...
    products: [
      ...
      { title: "Philips SmartSleep Wake-Up Light", description: "Sunrise simulation, better sleep quality, natural wake-up", rating: 4.5, imageUrl: philipsWakeupImg, affiliateLink: "https://www.amazon.com/dp/B07JXWS3Z8?tag=moderntechs0c-20" },
      { title: "Bose Sleepbuds II", description: "Sleep-focused earbuds, noise masking, better rest", rating: 4.3, imageUrl: boseSleepImg, affiliateLink: "https://www.amazon.com/dp/B08FRXBC79?tag=moderntechs0c-20" }
    ]
  },
  ...
  "st-patricks-day-tech-deals-2026": {
    ...
    sections: [
      ...
      { type: 'paragraph', content: "It sits in that sweet spot between post-holiday clearance sales and spring refresh promotions. Retailers are clearing out winter inventory to make room for new spring product launches, and brands like Amazon, Best Buy, and Samsung use themed sales events to drive traffic. The result? **Genuine discounts on top-tier tech** that you won't see again until Prime Day in July." },
      ...
      { type: 'paragraph', content: "Spring is the perfect time to upgrade your smart home. Retailers bundle smart speakers, lights, and security cameras into themed \"starter kits\" with steep savings. The **Philips Hue Starter Kit** is down 30%, and the **Ring Video Doorbell Pro 2** has a $60 discount — making it the best time to invest in home security." },
      { type: 'list', items: ["**Philips Hue Starter Kit** — 4 bulbs + bridge, 30% off, set the mood in emerald green ☘️", "**Echo Show 8 (3rd Gen)** — Smart display hub for your home, $40 off", "**Ring Doorbell Pro 2** — Best-in-class doorbell camera, $60 off"] },
      { type: 'heading', content: '🎮 Gaming Gear Gold' },
      { type: 'paragraph', content: "Gamers, this is your pot of gold. The **Meta Quest 3** is bundled with free games during the spring sale, and gaming monitors from ASUS and Samsung are seeing **up to 25% off**. The **Logitech G Pro X Superlight** mouse — a favorite among competitive gamers — is at its lowest price this year." },
      ...
      { type: 'list', items: ["**Stack coupons** — Many retailers allow coupon codes on top of sale prices", "**Check price history** — Use tools like CamelCamelCamel to verify it's a real deal", "**Act fast** — St. Patrick's Day deals typically run March 10-17, and popular items sell out", "**Sign up for alerts** — Bookmark this page; we'll update prices as new deals drop"] },
      { type: 'heading', content: 'The Bottom Line' },
      { type: 'paragraph', content: "St. Patrick's Day 2026 is shaping up to be one of the best early-spring shopping events for tech. Whether you're treating yourself or getting a head start on gifts, these deals represent **real savings on products we've tested and recommend**. Don't wait for Prime Day — the luck is here right now. ☘️" }
    ],
    products: [
