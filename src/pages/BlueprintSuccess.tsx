  ...
  return (
    <div className="vogue-theme min-h-screen" style={{ backgroundColor: "hsl(0 0% 100%)", color: "hsl(220 15% 14%)" }}>
      ...
      <section className="max-w-[600px] mx-auto px-8 pt-28 pb-20 text-center">
        <div className="w-16 h-16 mx-auto mb-8 flex items-center justify-center" style={{ border: "0.5px solid hsl(220 15% 14% / 0.15)" }}>
          <Check className="w-8 h-8" style={{ color: "hsl(220 15% 14% / 0.6)" }} />
        </div>
        ...
        <p className="font-serif text-lg leading-relaxed mb-4" style={{ fontWeight: 300, color: "hsl(220 15% 14% / 0.7)" }}>
          Check your email for your download link.
        </p>
        <p className="font-serif text-lg leading-relaxed mb-12" style={{ fontWeight: 300, color: "hsl(220 15% 14% / 0.7)" }}>
