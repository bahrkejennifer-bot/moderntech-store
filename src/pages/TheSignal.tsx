  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "hsl(30 8% 8%)", color: "hsl(30 25% 95%)" }}>
      ...
      <section className="max-w-[900px] mx-auto px-4 md:px-8 py-12">
        ...
        <div className="w-full overflow-hidden" style={{ border: "0.5px solid hsl(30 25% 95% / 0.08)" }}>
          <video
      ...
      <section className="max-w-[800px] mx-auto px-4 md:px-8 py-16 text-center">
        <p className="font-mono text-[9px] tracking-[0.4em] uppercase mb-6" style={{ color: "hsl(30 25% 95% / 0.3)" }}>
        ...
        <p className="font-serif text-lg md:text-xl mb-8" style={{ fontWeight: 300, fontStyle: "italic", color: "hsl(30 25% 95% / 0.5)" }}>
          A weekly conversation about technology, work, and the future.
        </p>
        <p className="font-mono text-[11px] leading-relaxed max-w-[540px] mx-auto" style={{ color: "hsl(30 25% 95% / 0.45)" }}>
