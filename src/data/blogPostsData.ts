...
export const blogProductImageMap: Record<string, string> = {
  "whoop 5.0": whoop5Img,
...
export const findProductImage = (title: string): string => {
...
export const asinToSlug: Record<string, string> = {
...
export const amznToSlug: Record<string, string> = {
